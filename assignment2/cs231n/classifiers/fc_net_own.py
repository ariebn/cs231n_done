...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3 * 32 * 32, num_classes=10,
        ...
        for i in range(0, self.num_layers):
            ...
            self.params[W_name] = np.random.normal(scale=weight_scale,
    ...
    def loss(self, X, y=None):
        ...
        for i in range(1, self.num_layers + 1):
            ...
            if i == self.num_layers:
                ...
                if self.use_batchnorm:
                    scores, self.batchnorm_cache[batchnorm_name] = batchnorm_forward(scores, self.params[gamma_name],
        ...
        for i in range(self.num_layers, 0, -1):
            ...
            if i == self.num_layers:
                ...
                if self.use_batchnorm:
                    der, grads[gamma_name], grads[beta_name] = batchnorm_backward(der,
                                                                                  self.batchnorm_cache[batchnorm_name])
